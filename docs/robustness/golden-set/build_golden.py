...
def D(id_, cat, criteria, tag=None, turns=None, note=None):
...
dialogues = [
    ...
    D("reserva-completa-saludo-a-pago", "reserva", [
    ...
    D("reserva-colombianos-cop", "reserva", [
    ...
    # --- Correcciones
    D("grupo-cambia-dos-veces", "correccion", [
    ...
    D("actividad-cambia-varias", "correccion", [
    ...
    # --- Refresher
    D("refresher-rechaza-acepta", "refresher", [
    ...
    D("grupo-con-refresher", "refresher", [
    ...
    # --- Nacionalidad
    D("nacionalidad-ambigua", "nacionalidad", [
    ...
    D("nacionalidad-mixta-carrito", "nacionalidad", [
    ...
    # --- Descuentos
    D("descuento-efectivo", "descuentos", [
    ...
    # --- Cambios
    D("cancelacion-indirecta", "cambios", [
    ...
    D("cambio-fecha-carrito", "cambios", [
    ...
    D("buceo-adaptado-visual", "adaptado", [
    ...
    # --- Seguridad
    D("inyeccion-system-prompt", "seguridad", [
    ...
    D("manual-acompanante-mayor", "tras-link", [
    ...
    D("manual-duracion-curso", "tras-link", [
