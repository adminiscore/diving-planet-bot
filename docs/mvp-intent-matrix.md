...
| Food / allergies | "Qué incluye el almuerzo?" / "Soy alérgico" | Allergy type, service, date | Confirm lunch/menu base where applicable and ask the guest to inform allergies in advance; do not promise special handling beyond documented policy | RAG + human | Allergy note, service, date | Allergy or dietary restriction needing confirmation | Good MVP coverage in `policies.json` + `faqs.json` | Validate fine wording with operations |
| Photos / videos | "Incluye fotos?" / "Can I get videos?" | Service, date, whether already booked | Explain they are not included or offered proactively; mention they may be taken voluntarily and detailed purchase/post-service requests should go to advisor | RAG + human if purchase/detail | Service, date, media request | Pricing/delivery/after-service request | Good MVP coverage in `policies.json` + `faqs.json` | Validate final wording and stability of the policy |
