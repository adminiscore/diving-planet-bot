...
| Descuentos | Cubierto para MVP | `discounts.json`: descuento online/directo (10%), grupo ≥5 personas (10%, no aplica a cursos PADI, no automático), segundo día, equipo propio COMPLETO (5%). Combinaciones y restricciones documentadas. **Descuento colombiano ELIMINADO** (decisión del owner, v0.18.0): no hay descuento por nacionalidad; colombianos/residentes pagan en COP e internacionales en USD, mismo precio. | Ninguno crítico para MVP. | Ninguno (cerrado). |
