...
reserva (detalle completo en `docs/archive/live-test-inconsistencies-plan.md`). Los 4 fixes se
...
`docs/archive/live-test-inconsistencies-plan.md`) puede servir de caso de prueba concreto para
esa decisión.
