...
* **Pendiente**: reindexar KB (`$env:ENV_FILE=".env.dev"; python -m scripts.load_embeddings`) para que RAG sirva los cambios de `brand_tone.json`/`discounts.json`/`policies.json`/`faqs.json`.
